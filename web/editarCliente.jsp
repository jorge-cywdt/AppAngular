                ...
                <div class="card bg-dark text-white">
                    ...
                    <div class="card-body">                       
                        ...
                        <form action="controladorCliente" method="post" id="formulario"> <!-- novalidate -->                            
                            ...
                            <h4>
                                <button type="submit" name="action" value="updateCliente" class="btn btn-secondary">Crear Cliente</button>
                                <a class="btn btn-secondary" href="controladorCliente?action=listarCliente">Atras</a>
                            </h4>                    

                            <input type="hidden" name="id" value="${ cliente.getId() }" id="id" class="form-control">
                        </form>                                                                 
